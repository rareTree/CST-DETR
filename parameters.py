...
def get_params(argv='1'):
    ...
    params = dict(
        ...
        pretrained_model_weights='output/2023/33_1_dev_split0_multiaccdoa_foa/models_test_12.20/model.h5',
        ...
        model_dir='models_test_12.21/',  # Dumps the trained models and training curves in this folder
