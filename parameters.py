...
def get_params(argv='1'):
    ...
    params = dict(
        ...
        pretrained_model_weights='output/2023/33_1_dev_split0_multiaccdoa_foa/models_syn/model.h5',
        ...
        model_dir='models_syn_1/',  # Dumps the trained models and training curves in this folder
